...
function getProfile($username, $db)
{
    // connect to DB
    $host = 'localhost';
    $user = 'webClient';
...
function updateRank($username, $db){
    // connect to DB
    $host = 'localhost';
    $user = 'webClient';
    $pass = 'GrAtMaPaLeGo';
...
function addCardIntoDeck($username, $deckno, $card, $db)
{
    // connect to DB
    $host = 'localhost';
    $user = 'webClient';
...
function requestProcessor($request)
{
  ...
  {
    case "login":
	    return doLogin($request['username'],$request['password'], $db);
    case "register":
	    return doRegister($request['username'],$request['password'], $db);
    case "profile":
	    return getProfile($request['username'], $db);
    case "ranking":
	    return updateRank($request['username'], $db);
    case "deck":
	    $card = array();
	    ...
	    return addCardIntoDeck($request['username'], $request['deckno'], $card, $db);
  }
